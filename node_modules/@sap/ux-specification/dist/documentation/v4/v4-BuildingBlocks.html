...
<body>
    <div id="version-container">SAP Fiori elements for OData V4<br />@sap/ux-specification 1.120.8</div>
...
<script>
    var floorPlanIcon;
    var treeData = {"name":"BuildingBlocks","description":"SAP Fiori elements for OData V4<br>@sap/ux-specification version 1.120.8","type":"schema","children":[{"name":"$filePath","children":[],"type":"string"}]};
